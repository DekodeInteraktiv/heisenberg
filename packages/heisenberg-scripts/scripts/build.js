...
process.env.BABEL_ENV = watchFiles ? 'development' : 'production';
process.env.NODE_ENV = watchFiles ? 'development' : 'production';
...
async function build() {
	if ( watchFiles ) {
		console.log( 'Creating an build...' );
		console.log();
		console.log( chalk.yellow( 'Note that watching builds is not optimized.' ) );
		console.log(
